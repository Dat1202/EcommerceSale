 ...
 */
package com.phd.configs;

import com.phd.filters.CustomAccessDeniedHandler;
import com.phd.filters.JwtAuthenticationTokenFilter;
import com.phd.filters.RestAuthenticationEntryPoint;
...
public class JwtSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.antMatcher("/api/**").httpBasic().authenticationEntryPoint(restServicesEntryPoint()).and()
                ...
                .antMatchers(HttpMethod.GET, "/api/**").access("hasRole('ROLE_ADMIN') or hasRole('ROLE_STORE')")

...
const Cart = () => {
    ...
    if (cart === null)
        return <Alert className="m-4 text-center" variant="info">Không có sản phẩm trong giỏ!</Alert>
                ...
                <div className="custom-border" style={{ paddingTop: "30px", backgroundColor: "red" }}>
                    <div className="d-flex justify-content-around">
                        ...
                        <div>
                            ...
                            {user === null ? <p>Vui lòng <Link to="/login?next=/cart">đăng nhập</Link> để thanh toán!</p> : <button className="mt-2 mb-2" onClick={showPay}>Thanh toán</button>}
                        </div>
                    </div>
                </div>
